        ...
        >
          ...
          {currState === "Sign up" && isDataSubmitted && (
            <textarea
              ...
              value={bio}
              rows={4}
              className="p-2 w-full border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
          ...
          <button
            type="submit"
            className="py-3 bg-gradient-to-r from-purple-400 to-violet-600 text-white rounded-md cursor-pointer w-full"
          >
